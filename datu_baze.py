...
# mycursor.execute("CREATE TABLE Iedzīvotāji (Vārds VARCHAR(255), Adrese VARCHAR(255))")
...
# sql = "INSERT INTO Iedzīvotāji (Vārds, Adrese) VALUES (%s, %s)"
# val = ("Santa", "Liepu iela 21")
